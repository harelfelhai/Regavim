...
# status: 'confirmed'|'approved'|'rejected'|'deletion_requested'
# Every report meets the reporting threshold: a violation category AND a
# description are always present (enforced by POST /api/v1/reports/submit).
REPORTS = [
    # ── CONFIRMED (just submitted) — meets threshold, awaiting manager review ─
    {
        "description": "הקמת מבנה יביל על עמודי בטון בשטח חקלאי פתוח — טרם חובר לתשתיות",
    ...
    {
        "description": "סלילת דרך עפר רחבה החוצה שטח פתוח לכיוון מאחז לא מוסדר",
    ...
    {
        "description": "יישור שטח בהיקף כדונם בעזרת טרקטור כבד, ללא היתר",
    ...
    {
        "description": "נטיעת מטע זיתים חדש בשטח ציבורי פתוח ללא הרשאה",
    ...
    {
        "description": "ערימות פסולת גזם ובניין שהושלכו בשולי ואדי בשטח פתוח",
    ...
    {
        "description": "פירוק מבנה ותיק ופינוי הריסות — ככל הנראה לקראת בנייה חדשה",
        "final_category": "DEMOLITION",
        "tags": ["ים המלח", "פרשייה ג"],
    ...
    {
        "description": "הרחבת מבנה מגורים קיים בתוספת אגף שלם — ללא היתר בנייה",
        "final_category": "ILLEGAL_CONSTRUCTION",
        "tags": ["שומרון צפוני"],
    ...
    {
        "description": "עבודות עפר וכלים כבדים להכשרת מגרש בשטח פתוח",
        "final_category": "LAND_GRADING",
        "tags": ["ערבה דרומית"],
    ...
    {
        "description": "גידור שטח פתוח בהיקף נרחב המונע מעבר ציבורי",
    ...
    {
        "description": "השתלטות חקלאית על קרקע מדינה — חריש ועיבוד ללא רישיון",
        "final_category": "AGRICULTURAL_ENCROACHMENT",
        "tags": ["גולן"],
